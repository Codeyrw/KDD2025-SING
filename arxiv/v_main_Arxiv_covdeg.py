    ...
    for epoch in range(400):
        ...
        for dataset_ind in range(len(datasets_tr)):
            ...
            for inner_steps in range(args.inner_steps):
                ...
                loss_generator = Mean  - args.dist_weight * Var + 1.0*loss_str #+ 1*con_loss
            ...
            z_res= rep-torch.sparse.mm(A,rep)/(D.unsqueeze(1))
            ...
            for k in range(0, args.K):
                ...
                z_res= rep-torch.sparse.mm(Ak.detach(),rep)/Dk
